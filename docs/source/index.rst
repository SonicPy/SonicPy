Welcome to sonicPy's user guide!
===================================
...
The data analysis package sonicPy consists of two GUI programs, Image-Analysis and Time-of-Flight that allow to estimate the values of d and t, respectively.  
...
:ref:`Before you begin <settingup>`
