...
A cross-correlation procedure measures the optimal interference between a waveform and its copy with a varying the ammount of phase shift. This process is used to calculate the time delay between any 2 pulses.
